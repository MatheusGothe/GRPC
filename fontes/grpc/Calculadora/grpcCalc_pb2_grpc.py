...
class apiStub(object):
    ...
    def __init__(self, channel):
        ...
        self.sum = channel.unary_unary(
                '/main.api/sum',
                request_serializer=grpcCalc__pb2.Operacao.SerializeToString,
                response_deserializer=grpcCalc__pb2.Resultado.FromString,
...
def add_apiServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'sum': grpc.unary_unary_rpc_method_handler(
                    servicer.sum,
                    request_deserializer=grpcCalc__pb2.Operacao.FromString,
                    response_serializer=grpcCalc__pb2.Resultado.SerializeToString,
            ),
...
class api(object):
    ...
    def sum(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/main.api/sum',
            grpcCalc__pb2.Operacao.SerializeToString,
            grpcCalc__pb2.Resultado.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
